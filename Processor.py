...
class Processor(object):
    ...
    def rotate_switch(self, nr, length, target_angle, op, speed, quadrant):
        ...
        print 'cos : ' + str(current_acos)
        print 'sin : ' + str(current_asin)
        if current_asin < 0:
    ...
    def animate_flow(self):
        try:
            ...
            self.master.after(10, self.animate_flow)
