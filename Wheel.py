...
class Wheel(object):
    def __init__(self, master, width, height, border, arrow_width):
        self.height = height * 12 / 16
        self.width = width * 4 / 16
        self.master = master
        ...
        self.wheel_canvas.grid(row=2, column=14, rowspan=12, columnspan=4)
        ...
        self.create_line(2 * arrow_width, 5 * arrow_width, 2 * arrow_width, self.height / 2, 0, 10, 1)
        self.create_line(0, 5 * arrow_width, 2 * arrow_width, 5 * arrow_width, 10, 0, 2)
        ...
        # fill command sequence from file
        self.init_command_sequence()
    ...
    def init_command_sequence(self):
        self.command_sequence = ['LOAD 0', 'STORE 1', 'A AND B', 'A OR B', 'LOAD 0', 'STORE 1', 'A AND B', 'A OR B',
                                 'LOAD 0', 'STORE 1', 'A AND B', 'A OR B', 'STORE 1', 'A AND B', 'A OR B', 'A OR B',
                                 'LOAD 0', 'STORE 1']
    ...
    def init_ringbuffer(self):
        ...
        for i in range(6, 0, -1):
            ...
            self.ringbuffer_data[i] = self.wheel_canvas.create_text(self.width / 2, self.height * (2 * i - 4) / 22,
                                                                    text=self.command_sequence[
                                                                        self.command_sequence_ptr], tags='MEM',
    ...
    def animate_flow(self):
        try:
            ...
            self.master.after(40, self.animate_flow)
