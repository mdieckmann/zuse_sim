...
class Cable(object):
    def __init__(self, master, width, height, arrow_width, border, exit_width_processor, exit_width_memop,
        ...
        self.cable_canvas.grid(row=1, column=4, rowspan=3, columnspan=10)
        ...
        self.color = 'red'
        self.create_line(self.width * 4 / 5, entry_height_wheel + self.height / 3, self.width,
                         entry_height_wheel + self.height / 3, 10, 0, 0)

        self.create_line(self.width * 4 / 5, entry_height_wheel + self.height / 3, self.width * 4 / 5, self.height / 3,
                         0, 10, 8)
        ...
        self.create_line(end_x_memop, end_y + 3 * arrow_width, exit_width_memop, end_y + 3 * arrow_width, 10, 0, 4)
